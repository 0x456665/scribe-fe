      ...
      <AnimatePresence>
        {menuOpen && (
          <motion.div
            ...
            className="flex flex-col items-center z-[100] justify-center absolute inset-0 bg-black/90 h-dvh gap-5"
          >
            <XIcon
              onClick={() => setMenuOpen(!menuOpen)}
              size={30}
            ...
            {!isLoggedIn ? (
              <>
                <Link
                  to="/login"
                  className="text-gray-300 hover:text-white px-4 py-3 rounded-md text-sm font-medium transition-colors bg-gradient-to-br from-purple-600 via-purple-500 w-28 grid place-content-center to-blue-500"
                ...
                <Link
                  to="/register"
                  className="text-gray-300 bg-gradient-to-br from-blue-500 via-purple-500 to-purple-600 hover:text-white px-4 py-3 rounded-md text-sm font-medium transition-colors w-28"
                  onClick={() => setMenuOpen(false)}
                >
                  Get started
                </Link>
